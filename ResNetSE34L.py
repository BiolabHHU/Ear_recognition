...
class ResNetSE(nn.Module):
    def __init__(self, block, layers, num_filters, nOut, encoder_type='SAP', n_mels=13, log_input=True, **kwargs):
        ...
        self.fc11 = nn.Linear(out_dim, nOut)
        self.fc2 = nn.Linear(nOut, 60)
